...
La~\cref{fig:comptinj} n'est pas une application.
...
%
  ...
  \end{figure}
  \clearpage
 Revenons une fois encore au comptage de mots pour trancher. Dans ce cas, on obtient : \sidepar{\vspace{\onelineskip} le  \textup{\texttt{\backslash0}} signale la fin d'un mot ou d'une chaîne de caractères (caractère 0 en ASCII)}
\begin{table}[h]
\centering
\begin{tabular}{llllll} 
