...
\end{defb}
On introduit aussi les deux définitions suivantes (qu'on illustrera ensuite) : 
...
De même, soit $K$ une partie de $Y$, on note $f^\leftarrow(K)$ l'ensemble des antécédents des éléments de $K$
\end{defb}
